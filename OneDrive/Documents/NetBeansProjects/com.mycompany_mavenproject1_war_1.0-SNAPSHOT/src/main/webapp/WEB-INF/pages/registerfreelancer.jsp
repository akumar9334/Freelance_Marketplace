<%-- 
    Document   : registerfreelancer
    Created on : Feb 6, 2025, 12:49:22 PM
    Author     : kumar
--%>
...
<html lang="en">
  ...
  <body>
    ...
    <form id="freelancerForm" action="registerfreelancerdata" class="form" method="post" enctype="multipart/form-data">
    <div class="column">
        <div class="input-box">
    ...
    <div class="column">
        <div class="input-box">
            ...
            <input type="text" placeholder="Enter phone number" name="number" required pattern="\d{10,15}" title="Please enter a valid phone number with 10-15 digits." />
        </div>
        <div class="input-box">
    ...
    <div class="column">
        <div class="input-box">
            ...
            <input type="url" placeholder="Enter Your LinkedIn Username/Link" required name="linkedin" />
        </div>
        <div class="input-box">
            <label>Educational Qualification</label>
            <input type="text" placeholder="Enter Your Educational Qualification" required name="education" />
        </div>
    </div>
    <div class="column">
        <div class="form-group file-area input-box">
            <label for="fprofilephoto"><span>Upload Your Profile Photo</span></label>
            <input type="file" name="filnamef" id="fprofilephoto" accept="image/*" required />
        </div>
        <div class="input-box">
            <label>Basic Charge for your Work</label>
            <input type="text" placeholder="Enter Your Basic Charge for your Work" required name="charge" pattern="^\d+(\.\d{1,2})?$" title="Please enter a valid amount." />
        </div>
    </div>
    <br>
