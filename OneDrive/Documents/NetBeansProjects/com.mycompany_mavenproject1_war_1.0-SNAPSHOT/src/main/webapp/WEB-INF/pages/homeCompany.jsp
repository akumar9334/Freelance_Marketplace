...
<script>
 ...
 $(document).ready(function () {
        // Time in milliseconds before session timeout to show the warning
        var warningTime = 300000; // 5 minutes (300,000 milliseconds)

        // Total session timeout in milliseconds (6 minutes)
        var sessionTimeout = 360000; // 6 minutes (360,000 milliseconds)

        // Set a timeout to show the warning
        setTimeout(function () {
            Swal.fire({
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    ...
                    $.post('/keep-alive', function (response) {
                        // Reset the timers or handle the response as needed
                        location.reload(); // Reload the page to reset timers
                    });
                } else {
