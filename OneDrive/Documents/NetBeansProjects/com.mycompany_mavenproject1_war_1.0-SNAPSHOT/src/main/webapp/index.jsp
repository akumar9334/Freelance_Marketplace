...
<html>
    <head>
        ...
        <title>welcome to myproject</title>
         <!-- Bootstrap CSS -->
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/files/css/bootstrap.css" />
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/files/css/style.css" />
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/files/css/responsive.css" />


<script src="${pageContext.request.contextPath}/files/js/your-javascript-file.js"></script>
        ...
        <nav class="navbar navbar-expand-lg custom_nav-container">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav  ">
              ...
              <li class="nav-item">
                <a class="nav-link" href="<c:url value='/registerfreelancer' />">Login As Freelancer &nbsp; <i class="fa-solid fa-users"></i></a>
              </li>
            </ul>
           <div class="user_option">
             <a href="<c:url value='/loginCompany' />">
 ...
 <center> <a href="#" title="LinkedIn" class="btn btn-linkedin btn-lg" style="background-color:#3a86ff;"">View More & Apply  &nbsp;<i class="fa-solid fa-arrow-up-right-from-square"></i></a></center>
        ...
        <div class="col-md-3 col-lg-4">
            <div class="card mb-4 project" data-groups="[&quot;skill1&quot;]">
                <figure class="portfolio-item">
                    <a href="<c:url value='/loginf' />" class="hovereffect">
                ...
                <div class="card-body">
                    ...
                    <br>
                    <a href="single-project6.html" class="card-title title-link fs-16 fw-bold">
                        Gauravinfo Technologies
                    </a>
                    <p class="card-text mt-3 fs-14" style="color:blue;"><b>Required Skills:</b>Spring Boot, Spring MVC, Postgresql, Hibernate, SQL</p>
                    <center>
                        <a href="<c:url value='/loginf' />">
                            <button type="button" class="btn btn-primary">View and Apply <i class="fa-solid fa-angles-right"></i></button>
                        </a>
                    </center>
                </div><!-- / card-body -->
            </div><!-- / card -->
...
Negotiation</p>
            <center> <a href="<c:url value='/loginf' />"><button type="button" class="btn btn-primary">View and Apply</button></a></center>
          </div><!-- / card-body -->
        </div><!-- / card -->
      </div><!-- / col-md-6 -->
...
Health administration</a>
            ...
            <center><a href="<c:url value='/loginf' />"><button type="button" class="btn btn-primary">View and Apply <i class="fa-solid fa-angles-right"></i></button></a></center>
...
Employee tracking system</a>
            ...
            <center><a href="#"><button type="button" class="btn btn-primary">View and Apply <i class="fa-solid fa-angles-right"></i></button></a></center>
...
Building chatbots</a>
 ...
 <center> <a href="#" title="LinkedIn" class="btn btn-linkedin btn-lg" style="background-color:#3a86ff;"">View More<i class="fa-solid fa-caret-right"></i><i class="fa-solid fa-caret-right"></i></a></center>
